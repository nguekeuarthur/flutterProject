...
import 'package:gestachat/pages/screens/add_task.dart';
import 'package:gestachat/pages/screens/hom_screen.dart';
import 'package:gestachat/pages/screens/list_task.dart';
import 'package:gestachat/pages/screens/profile.dart';
...
void _onItemTapped(int index) {
 ...
 @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar (
        title: const Center(child:Text("WantaMarket")  ,) 
      ) ,
      body: Center(child: 
